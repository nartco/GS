...
function resourceAttributesSourceFactory(persistence, deviceInfo) {
    return function resourceAttributesSource(config) {
        let getDeviceId;
        let deviceId;
        const attributes = new ResourceAttributes(config.releaseStage, config.appVersion, deviceInfo?.bundleIdentifier || 'unknown_service', 'bugsnag.performance.reactnative', '2.9.0');
...
export { resourceAttributesSourceFactory as default };
