...
const createClock = (performance) => {
    ...
    return {
        ...
        convert: (date) => date.getTime() - startWallTime + startPerfTime,
        // convert milliseconds since timeOrigin to full timestamp
        toUnixTimestampNanoseconds: (time) => millisecondsToNanoseconds(time - startPerfTime + startWallTime).toString()
    };
};
