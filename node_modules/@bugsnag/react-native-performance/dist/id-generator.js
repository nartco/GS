...
const isNativeModuleEnabled = (nativeModule) => {
...
function createIdGenerator(NativeBugsnagPerformance, isDebuggingRemotely = false) {
...
export { createRandomString, createIdGenerator as default, toHex };
